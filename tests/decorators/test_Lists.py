...
class test_Lists(Unit_Test):
    ...
    def test_group_by(self):
        assert self.get_data(group_by='key'   ) == { 'key_1'  : [ {'answer': '42', 'key': 'key_1', 'value': 'value_1'},
                                                                  {'answer': 'not 42', 'key': 'key_1', 'value': 'value_2'}],
                                                     'key_2'  : [ {'answer': '42', 'key': 'key_2', 'value': 'value_1'},
                                                                  {'answer': '42 not', 'key': 'key_2', 'value': 'value_1'}]}
        assert self.get_data(group_by='value' ) == { 'value_1': [ {'answer': '42', 'key': 'key_1', 'value': 'value_1'},
                                                                  {'answer': '42', 'key': 'key_2', 'value': 'value_1'},
                                                                  {'answer': '42 not', 'key': 'key_2', 'value': 'value_1'}],
                                                     'value_2': [ {'answer': 'not 42', 'key': 'key_1', 'value': 'value_2'}]}
        assert self.get_data(group_by='answer') == { '42'     : [ {'answer': '42', 'key': 'key_1', 'value': 'value_1'},
                                                                  {'answer': '42', 'key': 'key_2', 'value': 'value_1'}],
                                                     '42 not' : [ {'answer': '42 not', 'key': 'key_2', 'value': 'value_1'}],
                                                     'not 42' : [ {'answer': 'not 42', 'key': 'key_1', 'value': 'value_2'}]}